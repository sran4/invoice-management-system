...
export default function TemplatesPage() {
  ...
  const templates: Template[] = [
    ...
    },
    {
      ...
      description:
        "Vibrant and creative design perfect for creative professionals",
      category: "creative",
  ...
  const handleSelectTemplate = (templateId: string) => {
    ...
    toast.success(
      `Selected ${templates.find((t) => t.id === templateId)?.name} template!`
    );
                ...
                >
                  <CardHeader>
                    <div className="flex items-center justify-between mb-4">
                      <div
                        className={`w-12 h-12 gradient-red-blue rounded-lg flex items-center justify-center`}
                      >
